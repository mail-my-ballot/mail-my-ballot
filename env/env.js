...
const mailMyBallotNames = {
  BRAND_NAME: 'MailMyBallot.org',
  DOMAIN_NAME: 'mailmyballot.org',
  DEV_GCLOUD_PROJECT: 'mmb-dev-cee81',
  STAGING_GCLOUD_PROJECT: 'mmb-staging',
  PROD_GCLOUD_PROJECT: 'mmb-prod',
}

const names = mailMyBallotNames
...
const base = removeNullValues({
  ...
  RECEIVE_FAX_NUMBER,
  USER_MAX_ORGS: 8,
  REACT_APP_BRAND_NAME: names.BRAND_NAME + '.org',
  REACT_APP_URL: 'https://' + names.DOMAIN_NAME,
  REACT_APP_ELECTION_AND_DATE: 'the General Election on Tuesday, November 3rd, 2020',
  REACT_APP_FEEDBACK_ADDR: 'feedback@' + names.DOMAIN_NAME,
  REACT_APP_ELECTION_OFFICIAL_ADDR: 'elections@' + names.DOMAIN_NAME,
  REACT_APP_SUPPORT_ADDR: 'support@' + names.DOMAIN_NAME,
  MG_DOMAIN: 'email.' + names.DOMAIN_NAME,
  MG_FROM_ADDR: 'Vote by Mail Application <application@email.' + names.DOMAIN_NAME + '>',
  MG_REPLY_TO_ADDR: 'Vote by Mail Application <application@' + names.DOMAIN_NAME + '>',
...
const development = removeNullValues({
  ...
  GCLOUD_PROJECT: names.DEV_GCLOUD_PROJECT,
  ...
  FIRESTORE_URL: 'https://' + names.DEV_GCLOUD_PROJECT + '.firebaseio.com',
  ...
  GOOGLE_STORAGE_BUCKET: names.DEV_GCLOUD_PROJECT + '.appspot.com',
...
const staging = removeNullValues({
  ...
  GCLOUD_PROJECT: names.STAGING_GCLOUD_PROJECT,
  ...
  REACT_APP_BRAND_NAME: 'Staging.' + names.BRAND_NAME + '.org',
  REACT_APP_URL: 'https://staging.' + names.DOMAIN_NAME + '/',
  FIRESTORE_URL: 'https://' + names.STAGING_GCLOUD_PROJECT + '.firebaseio.com',
  REACT_APP_SERVER: 'https://app-staging.' + names.DOMAIN_NAME + '/',
  ...
  GOOGLE_CLIENT_CALLBACK: 'https://app-staging.' + names.DOMAIN_NAME + '/auth/google/callback',
  GOOGLE_STORAGE_BUCKET: names.STAGING_GCLOUD_PROJECT + '.appspot.com',
...
const production = removeNullValues({
  ...
  GCLOUD_PROJECT: names.PROD_GCLOUD_PROJECT,
  ...
  REACT_APP_BRAND_NAME: names.BRAND_NAME,
  REACT_APP_URL: 'https://' + names.DOMAIN_NAME + '/',
  FIRESTORE_URL: 'https://' + names.PROD_GCLOUD_PROJECT + '.firebaseio.com',
  REACT_APP_SERVER: 'https://app.' + names.DOMAIN_NAME + '/',
  ...
  GOOGLE_CLIENT_CALLBACK: 'https://app.' + names.DOMAIN_NAME + '/auth/google/callback',
  GOOGLE_STORAGE_BUCKET: names.PROD_GCLOUD_PROJECT + '.appspot.com',
