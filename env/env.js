...
const base = removeNullValues({
  ...
  REACT_APP_FEEDBACK_ADDR: 'rahul952ln@gmail.com',
  REACT_APP_ELECTION_OFFICIAL_ADDR: 'elections@mailmyballot.org',
  REACT_APP_SUPPORT_ADDR: 'rahul952ln@gmail.com',
  MG_DOMAIN: 'email.mailmyballot.org',
  MG_FROM_ADDR: 'Vote by Mail Application <rahul952ln@gmail.com>',
  MG_REPLY_TO_ADDR: 'Vote by Mail Application <rahul952ln@gmail.com>',
...
const development = removeNullValues({
  ...
  GOOGLE_APPLICATION_CREDENTIALS: './secrets/test-voting-278605-firebase-adminsdk-crde8-ba30654bcb.json',
  REACT_APP_GOOGLE_UA: 'UA-164550246-2',
  REACT_APP_URL: 'http://localhost:3000/',
  FIRESTORE_URL: 'https://test-voting-278605.firebaseio.com/',
...
const staging = removeNullValues({
  ...
  GOOGLE_STORAGE_BUCKET: 'test-voting.appspot.com',
